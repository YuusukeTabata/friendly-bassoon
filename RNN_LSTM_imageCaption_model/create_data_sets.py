...
tf.flags.DEFINE_string("train_captions", "./stair_captions_v1.2.tar/stair_captions_v1.2_train_tokenized.json", "Training caption file.")
tf.flags.DEFINE_string("val_captions", "./stair_captions_v1.2.tar/stair_captions_v1.2_val_tokenized.json", "Validation caption file.")
