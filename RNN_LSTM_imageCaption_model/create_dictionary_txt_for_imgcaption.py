...
tf.flags.DEFINE_string("train_img_dir", "./data/img/train_worldcup_2014", "Training image directory.")
tf.flags.DEFINE_string("val_img_dir", "./data/img/train_worldcup_2014", "Validation image directory.")
tf.flags.DEFINE_string("train_captions", "./stair_captions_v1.2.tar/stair_captions_v1.2_train_tokenized2.json", "Training caption file.")
tf.flags.DEFINE_string("val_captions", "./stair_captions_v1.2.tar/stair_captions_v1.2_train_tokenized2.json", "Validation caption file.")
tf.flags.DEFINE_string("out_dir", "./data/tfrecords/", "Output TFRecords directiory.")
tf.flags.DEFINE_integer("min_word_count", 1, "The minimum number of occurrences of each word in th training set for includion in the vocab.")
